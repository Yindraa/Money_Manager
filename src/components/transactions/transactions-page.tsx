      ...
      <section className="panel mt-4 overflow-visible p-0">
        ...
        <div className="hidden overflow-x-auto lg:block">
          <table className="w-full min-w-[1180px] text-left">
            ...
            <tbody>
              {filteredTransactions.map((item) => <tr key={item.id} className="border-b border-slate-100 align-top last:border-0 hover:bg-slate-50/70">
                ...
                <td className="px-3 py-3">{canEdit && <TransactionMenu transaction={item} onEdit={() => openEdit(item)} onDelete={() => setDeletingTransaction(item)} />}</td>
              </tr>)}
